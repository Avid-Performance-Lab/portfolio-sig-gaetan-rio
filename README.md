...
Série de cartes thématiques réalisées dans le cadre d'un diagnostic territorial complet, en appliquant la réglementation littoral et les outils de protection environnementale.

#### 2a — Zones de protection réglementaire
Cartographie croisée des protections foncières (Conservatoire du Littoral, ENS), réglementaires (Loi Littoral, zones humides, espaces boisés classés) et patrimoniales (ZNIEFF 1).  
...
Sources : IGN · Auteur : Gaétan Rio

![Carte pentes et hydrologie](travaux/Carte_des_pentes_niveaux_et_hydro_Moelan.png)
...
> Délibéré au Bureau Communautaire le 10/05/2022 — Transmis en préfecture le 25/05/2022

**Contexte :** Révision du schéma directeur cyclable intercommunal à l'échelle des 14 communes de Quimperlé Communauté.

**Contenu :** Cartographie des itinéraires intercommunaux (12 itinéraires, 7 496 k€ HT) et des liaisons locales (16 itinéraires, 1 922 k€ HT) · Hiérarchisation par niveau d'intérêt communautaire · Définition du fonds de concours adapté · Présentation aux élus.
...
![Carte SDC — vue d'ensemble des itinéraires](travaux/apercu_carte_SDC2022_2.png)

![Carte SDC — exemple liaisons locales Bannalec](travaux/apercu_carte_SDC2022.png)

> *Document officiel délibéré et transmis en préfecture — réalisation opérationnelle en collectivité.*
...
Cartographie réglementaire PLU intégrant les contraintes agricoles (L111-3, L151-19, L151-23), corridors de protection SDAGE, zones de recul voirie départementale, ZPPA, zones humides et espaces boisés classés.
...
### 5 — Parc Naturel Régional d'Armorique — étude territoriale

> Projet universitaire — Master AUTELI, Université Bretagne Sud (2020)

Étude territoriale approfondie sur le PNRA : diagnostic environnemental, cartographies thématiques, analyse des enjeux paysagers et écologiques.

📄 [Voir le rendu complet](travaux/RENDU-FINAL-PNRA-2020.pdf)
